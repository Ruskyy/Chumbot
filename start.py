...
async def comandos():
    ...
    embed.add_field(name="!pergunta [texto]", value="basicamente uma 8-Ball", inline=False)
    ...
    embed.add_field(name="!reverse [texto]", value="reverte a mensagem", inline=False)
    embed.add_field(name="!spam", value="partilha spam no chat", inline=False)
    embed.add_field(name="!spellout [texto]", value="L E T R A  A  L E T R A ", inline=False)
    embed.add_field(name="!morse [texto]", value="converte para morse ", inline=False)
    embed.add_field(name="!remorse [texto]", value="converte de morse ", inline=False)
    embed.add_field(name="!intelectual [texto]", value="InTeLeCtUaL", inline=False)
    embed.add_field(name="!owo [texto]", value=" hehe piwinha owo", inline=False)
